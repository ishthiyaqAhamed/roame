  ...
  return (
    <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <h1 className="font-serif-luxury text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight">
      ...
      <div className="glass-card-gold rounded-2xl p-4 sm:p-6 mb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <div className="flex flex-col">
            <label className="text-[10px] uppercase font-semibold text-[#8E95A5] mb-1">
              Search Make / Model
            </label>
            <div className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-xl px-3 py-2">
              ...
              <input
                ...
                className="bg-transparent text-xs sm:text-sm text-white focus:outline-none w-full"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              className="bg-[#10121A] text-xs sm:text-sm text-white border border-white/10 rounded-xl px-3 py-2.5 focus:outline-none"
            >
              {districts.map((d) => (
          ...
          <div className="flex flex-col">
            <div className="flex justify-between items-center mb-1">
              <label className="text-[10px] uppercase font-semibold text-[#8E95A5]">
                Max Price / Day
              </label>
            ...
            <input
              ...
              className="accent-[#D4AF37] h-2 bg-white/10 rounded-lg cursor-pointer mt-3"
            />
          </div>
        </div>
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-medium transition-all ${
                  category === c.id
                    ...
                    : "text-[#8E95A5] hover:text-white bg-white/5"
                }`}
              >
      ...
      <div className="flex items-center justify-between mb-6">
        <span className="text-xs text-[#8E95A5]">
          Showing <strong className="text-white">{filtered.length}</strong> verified vehicles in Sri Lanka
        </span>
      </div>
      ...
      {filtered.length === 0 ? (
        <div className="glass-card-gold rounded-3xl p-12 text-center">
          <p className="text-base text-white font-semibold mb-2">No vehicles found matching your filters</p>
          <p className="text-xs text-[#8E95A5] mb-6">Try resetting your district or price range filters</p>
          <button
            onClick={() => {
              setCategory("ALL");
            ...
            >
              ...
              <div className="relative h-56 w-full overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-black/70 backdrop-blur-md border border-[#D4AF37]/30 text-[#F3E5AB]">
              ...
              {/* Details */}
              <div className="p-6 flex-1 flex flex-col justify-between bg-[#10121A]">
                <div>
                  <div className="flex items-start justify-between gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-1 bg-[#D4AF37]/10 px-2 py-1 rounded-lg border border-[#D4AF37]/20">
                  ...
                  {/* Chips */}
                  <div className="flex flex-wrap items-center gap-2 my-4 text-[11px] text-[#8E95A5]">
                  ...
                  <p className="text-xs text-[#D4AF37] font-medium bg-[#D4AF37]/5 px-3 py-2 rounded-xl border border-[#D4AF37]/10 mb-6">
                    {vehicle.kmIncluded}
                  </p>
                </div>
                ...
                <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                  <div>
                    <span className="text-[10px] uppercase tracking-wider text-[#8E95A5] block">
                      Daily Rate
                    </span>
...
export default function VehiclesPage() {
  return (
    <Suspense fallback={<div className="min-h-screen pt-32 text-center text-[#8E95A5]">Loading vehicle catalog...</div>}>
